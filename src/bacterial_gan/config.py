...
class TrainingConfig(BaseModel):
    ...
    learning_rate_g: float = 0.0001  # Generator learning rate
    learning_rate_d: float = 0.0004  # Discriminator learning rate (4x Generator)
    ...
    n_critic: int = 5  # Increased to 5 (Standard WGAN-GP)
